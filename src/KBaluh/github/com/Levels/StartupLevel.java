...
public class StartupLevel extends Level {
     ...
     */
    private Bitmap background = loadImage(R.drawable.background);
     ...
     */
    public StartupLevel(Context context, GameScreen gameScreen) {
    ...
    protected void paintPanel(Canvas g) {
        ...
        g.drawText("Level: " + getLevelNumber() + ", Battle: " + battleNumber +
                ...
                ", Scores: " + player.getScores(), 10, 20, paint);
        ...
        g.drawText("Player life: " + player.getHp(), 10, 35, paint);
    }
     ...
     */
    protected void setBackground(Bitmap image) {
        background = image;
    }
     ...
     * @param entity - Entity
     */
    private void paintEntity(Canvas g, Entity entity) {
        Bitmap image = entity.getImage();
        if (image != null) {
            g.drawBitmap(image, entity.getX(), entity.getY(), null);
        }
    }
    ...
    public void onAccuracyChanged(Sensor sensor, int accuracy) {
        ...
        player.onAccuracyChanged(sensor, accuracy);
    }
     ...
     * @param entityList - decoration entities
     */
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        return player.onTouchEvent(e);
    }

    private void paintBattleText(Canvas g) {
        Paint paint = new Paint();
        paint.setColor(Color.WHITE);
        paint.setTextSize(18);
        g.drawText(battleShowText, gameScreen.getWidth()/2, gameScreen.getHeight()/2, paint);
    }
}
